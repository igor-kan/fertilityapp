# Contributing to fertilityapp

Thank you for your interest in contributing to fertilityapp! This document provides guidelines and instructions for contributing to this project.
...
2. **Clone your fork** locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/fertilityapp.git
   cd fertilityapp
   ```
3. **Add the upstream remote**:
   ```bash
   git remote add upstream https://github.com/igor-kan/fertilityapp.git
   ```
...
By contributing to fertilityapp, you agree that your contributions will be licensed under the project's [MIT License](LICENSE).
